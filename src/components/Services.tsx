...
const services = [
  ...
  },
  {
    ...
    description:
      "Robust, scalable front-end solutions built with modern frameworks.",
  },
  {
    icon: Layers,
    title: "Full Stack Development",
    description:
      "I build complete web applications from front-end to back-end using modern technologies.",
  },
];
        ...
        <div className="mb-32 grid md:grid-cols-2 gap-16 items-end">
          ...
          >
            ...
            <p className="text-xl md:text-2xl font-light text-neutral-300 leading-relaxed">
              I combine aesthetic precision with technical robustness to build
