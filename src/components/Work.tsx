              ...
              <Link to={`/work/${project.slug}`}>
                <div className="relative overflow-hidden aspect-[3/4] mb-6 bg-neutral-900 rounded-sm">
                  <img
                    src={project.image}
                    alt={project.title}
                    className={`w-full h-full group-hover:scale-105 group-hover:opacity-100 transition-all duration-700 opacity-80 ${
                      project.isLogo ? "object-contain p-12" : "object-cover"
                    }`}
                  />
